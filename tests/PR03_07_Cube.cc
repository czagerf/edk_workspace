...
void InitScene() {
  ...
  //Creating a cube:
  EDK::ref_ptr<EDK::CubeCustom> cube_geo;
  cube_geo.alloc();
  cube_geo->init8v();

  EDK::ref_ptr<EDK::CubeCustom> cube_geo2;
  cube_geo2.alloc();
  cube_geo2->init24v();
  ...
  */
  ...
  EDK::ref_ptr<EDK::Drawable> drawable3;
  EDK::ref_ptr<EDK::Drawable> drawable4;
  drawable.alloc();
  drawable2.alloc();
  drawable3.alloc();
  drawable4.alloc();
  ...
  drawable->set_position(-1.0f,1.0f,0.0f);
  ...
  drawable2->set_position(1.0f, 1.0f, 0.0f);

  node_1->addChild(drawable2.get());

  root->addChild(node_1.get());
  
  drawable3->set_geometry(cube_geo2.get());
  drawable3->set_material(cube_mat.get());
  drawable3->set_material_settings(cube_mat_set.get());
  drawable3->set_position(-1.0f,-1.0f,0.0f);

  node_2->addChild(drawable3.get());

  drawable4.alloc();
  drawable4->set_geometry(cube_geo2.get());
  drawable4->set_material(cube_mat2.get());
  drawable4->set_material_settings(cube_mat2_set.get());
  drawable4->set_position(1.0f, -1.0f, 0.0f);

  node_2->addChild(drawable4.get());

  root->addChild(node_2.get());
